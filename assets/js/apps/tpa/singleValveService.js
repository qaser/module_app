...
const calendar = new Calendar('.calendar__item', handleServiceClick, handleEmptyServiceClick);
...
function createWork(item) {
  const work = new Work(item, '.work-template', handleWorkClick, handlePhotoGalleryClick);
